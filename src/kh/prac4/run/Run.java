...
//		for (int i = 0; i < tempM.length; i++) { //성별과 혈액형이 일치하는 경우의 수를 배열에 담는다.
//			tempM[i] = new Member();			// 총 경우의 수가 8개 이므로 8개의 배열 선언.
//
//		}
//		int tempIndex = 0; //
...
//					}
//					if (k == tempM.length) { 
//						tempM[tempIndex++] = m[j];//tempM에 값을 넣는 코드//tempM에 값을 넣는 코드
//					}
//				}
//			}
//		}
